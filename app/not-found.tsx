    ...
    <div className="bg-page min-h-screen relative overflow-hidden flex flex-col items-center justify-center font-nunito">
      ...
      <div className="relative z-10 flex flex-col items-center text-center p-8">
        ...
        <div className="animate-fade-up" style={{ animationDelay: "0.8s" }}>
          <Link
            href="/"
            className="inline-flex items-center gap-2 bg-chewy-orange hover:bg-chewy-orange-dark text-white font-nunito font-bold px-7 py-3 rounded-full transition-colors shadow-md hover:shadow-lg"
          >
